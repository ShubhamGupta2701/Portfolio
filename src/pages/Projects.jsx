...
export const Projects = () => {
    return (
        <div>
            <div className="text-4xl flex items-center justify-center py-4 font-extrabold font-mono">
                Projects
            </div>
            <div className="container mx-auto px-4 md:px-10 lg:px-20 flex flex-wrap justify-center">
                <ProjectCard 
                    title={"Medium-Blog"}
