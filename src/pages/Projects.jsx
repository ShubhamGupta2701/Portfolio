...
export const Projects = () => {
    const handleContactClick = () => {
        const email = 'shubham272101@gmail.com';
        const subject = 'Project Inquiry - Portfolio';
        const body = 'Hi Shubham, I saw your portfolio and would like to discuss...';
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 py-8">
            ...
            <div className="text-center mt-12 px-4">
                ...
                <button 
                    ...
                    className="bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white font-semibold px-8 py-3 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30 transform hover:-translate-y-1"
                >
                    Get In Touch
                </button>
                <div className="text-sm text-gray-500 mt-2">
                    Opens Gmail with my email pre-filled
                </div>
            </div>

            {/* Decorative Elements */}
            <div className="absolute top-1/4 left-10 w-20 h-20 bg-purple-500/10 rounded-full blur-xl"></div>
            <div className="absolute bottom-1/4 right-10 w-32 h-32 bg-purple-300/5 rounded-full blur-xl"></div>
        </div>
    );
};